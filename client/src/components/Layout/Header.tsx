...
//           </li>
//           <li>
//             <Link to="/aboutUs" className="hover:text-cyan-500 text-cyan-600 font-semibold">
//               About Us
//             </Link>
//           </li>
//           <li>
//             <Link to="/products" className="hover:text-cyan-500 text-cyan-600 font-semibold">
//               Products
//             </Link>
//           </li>
//           <li>
//             <Link to="/blogs" className="hover:text-cyan-500 text-cyan-600 font-semibold">
//               Blogs
//             </Link>
//           </li>
//           <li>
  ...
  return (
    ...
    >
      <nav className="container mx-auto flex items-center justify-between p-2">
        ...
        <div className="hidden md:block">
          <Link to="/login">
            <Button className="bg-cyan-600 mr-2 text-white font-semibold">
              Login /SignUp
            </Button>
          </Link>
        </div>
        ...
        >
          ...
          <li>
            <Link to="/login" onClick={toggleMenu}>
              <Button className="bg-cyan-600 hover:bg-cyan-500 w-full text-white font-semibold">
                Login/SignUp
              </Button>
            </Link>
          </li>
