  ...
  return (
    <div className="container mx-auto mt-0 bg-slate-100 px-28 py-16 justify-items-center">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4  justify-items-center">
        ...
        {/* Card 1 */}
        <div className="flex flex-col bg-white shadow-sm border border-slate-200 rounded-lg w-56 h-96">
        ...
        <div className="flex flex-col bg-white shadow-sm border border-slate-200 rounded-lg w-56 h-96">
          <div className="relative p-3.5 h-64 sm:h-72 lg:h-96 overflow-hidden rounded-xl bg-clip-border flex justify-center">
            <img
              src="https://www.yudaah.com/demo/water-purifier-website-template/assets/images/product/p2.webp"
              alt="Apple AirPods"
              className="h-3/2 w-3/2 object-cover rounded-md"
            />
          </div>
        ...
        <div className="flex flex-col bg-white shadow-sm border border-slate-200 rounded-lg w-56 h-96">
          <div className="relative p-2 h-48 sm:h-56 lg:h-72 overflow-hidden rounded-xl bg-clip-border flex justify-center">
            <img
              src="https://www.yudaah.com/demo/water-purifier-website-template/assets/images/product/p3.webp"
              alt="Apple AirPods"
              className="h-3/2 w-3/2 object-cover rounded-md"
            />
          </div>
