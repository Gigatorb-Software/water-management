    ...
    <div className="rounded overflow-hidden shadow-lg flex flex-col">
      <a href="#">
        <div className="relative">
          ...
          <div className="text-xs absolute top-0 right-0 bg-cyan-600 px-4 py-2 text-white mt-3 mr-3 hover:bg-white hover:text-cyan-600 transition duration-500 ease-in-out">
            {tag}
          </div>
        </div>
      </a>
