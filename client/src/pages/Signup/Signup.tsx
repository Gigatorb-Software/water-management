          ...
          <div className="p-4 space-y-3 sm:p-4">
            ...
            <form onSubmit={handleSubmit} className="space-y-3">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                  <label htmlFor="street" className="block mb-1 text-xs font-medium text-gray-900 dark:text-white">
                    Street
                  </label>
                  <input
                    type="text"
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <label htmlFor="city" className="block mb-1 text-xs font-medium text-gray-900 dark:text-white">
                    City
                  </label>
                  <input
                    type="text"
                ...
                <div>
                  <label htmlFor="state" className="block mb-1 text-xs font-medium text-gray-900 dark:text-white">
                    State
                  </label>
                  <input
                    type="text"
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                  <label htmlFor="postalCode" className="block mb-1 text-xs font-medium text-gray-900 dark:text-white">
                    Postal Code
                  </label>
                  <input
                    type="text"
                ...
                <div>
                  <label htmlFor="country" className="block mb-1 text-xs font-medium text-gray-900 dark:text-white">
                    Country
                  </label>
                  <input
                    type="text"
